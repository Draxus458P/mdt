...
RegisterNUICallback("performEvidenceSearch", function(data, cb)
    TriggerServerEvent("mdt:performEvidenceSearch", data.query)
    cb('ok')
end)

RegisterNUICallback("submitNewEvidence", function(data, cb)
    TriggerServerEvent("mdt:submitNewEvidence", data.query)
    cb('ok')
end)
